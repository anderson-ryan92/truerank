    ...
    <main className="min-h-screen px-8 py-16 max-w-3xl mx-auto">
      ...
      <section className="mb-12">
        ...
        <ul className="space-y-3 text-gray-300 leading-relaxed">
          <li>
            <span className="font-semibold text-white">Actual testing.</span>{' '}
          ...
          <li>
            <span className="font-semibold text-white">Free data, free scores.</span>{' '}
            Everything is public. No paywall on findings.
          </li>
          <li>
            <span className="font-semibold text-white">No brand-paid testing.</span>{' '}
            Brands cannot pay to be tested. Brands cannot submit their own reports.
          </li>
          <li>
            <span className="font-semibold text-white">Multi-axis scoring.</span>{' '}
