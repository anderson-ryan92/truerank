      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link href="/account/favorites" className="block p-6 border border-gray-800 rounded-lg hover:border-gray-600 transition-colors">
            ...
            <p className="text-sm text-gray-500">{favoritesCount || 0} saved</p>
          </Link>
          <Link href="/account/history" className="block p-6 border border-gray-800 rounded-lg hover:border-gray-600 transition-colors">
            <h3 className="font-semibold mb-1">View history</h3>
            <p className="text-sm text-gray-500">Products you have viewed</p>
          </Link>
        </div>
      </section>

      {profile?.membership_tier !== 'pro' ? (
        <section className="p-6 border border-gray-800 rounded-lg bg-gray-950">
